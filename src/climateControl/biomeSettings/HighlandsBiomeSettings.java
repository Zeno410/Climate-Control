...
public class HighlandsBiomeSettings extends BiomeSettings {
   ...
   public final Element  bog = new Element("Bog", 204,true);
   public final Element  cliffs = new Element("Cliffs", 205);
   public final Element  desertMountains = new Element("Desert Mountains", 206,"HOT");
   public final Element  dunes = new Element("Dunes", 207);
   public final Element  estuary = new Element("Estuary", 208,"WARM");
   public final Element  flyingMountains = new Element("Flying Mountains", 209);
   public final Element  glacier = new Element("Glacier", 210);
   public final Element  highlandsb = new Element("Highlands", 211);
   public final Element  lowlands = new Element("Lowlands", 212);
   public final Element  meadow = new Element("Meadow", 213,true);
   public final ID  ocean2 = new ID("Improved Oceans",229);
   public final Element  outback = new Element("Outback", 214);
   ...
   public final Element  rockMountains = new Element("Rock Mountains", 218);
   public final Element  sahel = new Element("Sahel", 219,true);
   public final Element  savannah = new Element("Savannah", 220,true);
   public final Element  steppe = new Element("Steppe", 221,true);
   public final Element  snowMountains = new Element("Snow Mountains", 222);
   public final Element  tallPineForest = new Element("Tall Pine Forest", 223);
   public final Element  tropics = new Element("Tropics", 224,"HOT");
   public final Element  tropicalIslands = new Element("Tropical Islands", 225,1,true);
   public final Element  tundra = new Element("Tundra", 226);
   public final Element  woodlands = new Element("Woodlands", 227);
   public final Element  woodlandMountains = new Element("Woodland Mountains", 228);
