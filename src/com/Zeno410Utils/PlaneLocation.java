...
public class PlaneLocation {
    ...
    private void setX(int newX) {x = newX;}
    private void setZ(int newZ) {z = newZ;}

    public PlaneLocation(BlockPos coordinates) {
        this(coordinates.getX(),coordinates.getZ());
    }
    ...
    public static class Probe extends PlaneLocation {
        public Probe(int x, int z) {super(x,z);}
